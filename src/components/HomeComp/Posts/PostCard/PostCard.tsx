    ...
    return (
        <div className="border border-black rounded-md shadow-md shadow-[#ffffff3d] overflow-hidden">
            <div className="flex flex-col">
                <Link className="relative group" href={`/blog/${postCardData.id}`}>
                    <figure>
                ...
                <div className="flex shrink flex-col gap-8 p-4 my-4">
                    <h2 className="text-white text-2xl hover:text-[#4169e1] transition-all duration-500 font-medium">
                        <Link href={`/blog/${postCardData.id}`}>{postCardData.title}</Link>
                    </h2>
                    ...
                    <Link className="uppercase text-xs border rounded-sm border-[#C2AA6C] text-white p-2 hover:bg-[#C2AA6C] transition-all duration-500" href={`/blog/${postCardData.id}`}>Read More</Link>
                </div>
            </div>
        </div>
    );
