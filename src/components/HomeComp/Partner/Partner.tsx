...
const Partner = () => {
    ...
    return (
        <div className="py-5">
            ...
            <div>
                <figure>
                    <Image className="max-w-5xl mx-auto" width={1250} height={480} src="https://yukienatori-newyork.com/wp-content/uploads/2021/10/fb-1-e1628672112524-1024x358.jpg" alt="Partner" />
                </figure>
            </div>
            <div className="flex flex-col gap-12 justify-center items-center pb-12">
                ...
                <div>
                    <Link className="px-20 uppercase hover:bg-[#8DBFBE] transition-all duration-500 py-3.5 rounded-xs bg-black text-white" href="/" >BOOK MASSAGE OR FACIAL ONLINE</Link>
                </div>
            </div>
        </div>
    );
