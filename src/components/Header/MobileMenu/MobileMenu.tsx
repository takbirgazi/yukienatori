...
const MobileMenu: React.FC<MenuType> = ({ links }) => {
    ...
    return (
        <div className="block md:hidden">
            ...
            <div className={`${isActive ? "h-56" : "h-0"} md:hidden flex flex-col justify-center gap-5 absolute w-full left-0 top-[115px] bg-white transition-all duration-500 overflow-hidden`}>
                {
